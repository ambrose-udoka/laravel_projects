...
<body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <!-- <a class="nav-link" href="<?php //echo url('admin/dashboard'); ?>"> -->
              ...
              <!-- if using a named route: -->
            <a class="nav-link" href="<?php echo route('dash'); ?>">Dashboard</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="py-5 bg-image-full" style="background-image: url(<?php echo asset('images/surface.jpg') ;?>);height:260px;">
 ...
 <div class="col-md-2">
  ...
  <img src="images/logo2.png" class="card-img-top logoimg" alt="">
  <div class="card-body">
    <p class="card-text">The best sewing company in town, we deliver excellent services <code>Ikeja,Lagos</code></p>
  </div>
</div>
  ...
  <div class="card-body">
    <p class="card-text">The best sewing company in town, we deliver excellent services  
      <code>Ikeja,Lagos</code></p>
  </div>
</div>
<div class="col-md-3 featured">
  <img src="images/logo4.jpg" class="card-img-top logoimg" alt="">
  <div class="card-body">
    <p class="card-text">The best sewing company in town, we deliver excellent services <code>Ikeja,Lagos</code></p>
  </div>
</div>
 <div class="col-md-3 featured">
  <img src= '<?php echo asset("images/logo3.jpg"); ?>' class="card-img-top logoimg" alt="">
  <div class="card-body">
    <p class="card-text">The best sewing company in town, we deliver excellent services <code>Ikeja,Lagos</code></p>
  </div>
</div>
  ...
  <footer class="py-5 bg-dark">
    ...
    <a href = "login/user"><h2 style = 'color:blue'>Login</h2></a>
    <a href = "login/admin"><h2 style = 'color:blue'>Login</h2></a>
    <!-- /.container -->
  </footer>
